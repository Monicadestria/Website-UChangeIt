    ...
    <nav class="navbar navbar-expand-md bg-black navbar-light fixed-top">
      <div class="container">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a href="masuk.php" class="btn btn-light text-success rounded-3" style="font-weight: 600">Masuk</a>
          </li>
        </ul>
      </div>
      </div>
    ...
    <section id="section1">
      <div class="container h-100">
        <div class="col-md-6 my-auto">
          ...
          <a href="masuk.php" class="btn btn-light text-success p-3 me-2" style="font-size: 20px; font-weight: 600">Mulai Berubah</a>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card-services text-center">
              ...
              <a href="masuk.php" class="btn btn-light text-success rounded-3" style="font-weight: 600">Mulai Belajar</a>
            </div>
          </div>
          <!-- Kolom Kedua -->
          <div class="col-md-4">
            <div class="card-services text-center">
              ...
              <a href="masuk.php" class="btn btn-light text-success rounded-3" style="font-weight: 600"> Mulai Ubah </a>
            </div>
          </div>
          <!-- Kolom Ketiga -->
          <div class="col-md-4">
            <div class="card-services text-center">
              ...
              <a href="masuk.php" class="btn btn-light text-success rounded-3" style="font-weight: 600">Mulai Baca</a>
            </div>
          </div>
          <!-- Akhir Kolom -->
        </div>
